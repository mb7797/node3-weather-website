...
const forecast = (number1, number2, callback)=>{
  ...
  request({url, json: true}, (error, { body })=>{
    if (error){
      ...
      callback(undefined, body.daily.data[0].summary + '\n Die Temperatur liegt bei : ' + body.currently.temperature + ' Grad. Es herrscht eine Regenwahrscheinlichkeit von: ' + body.currently.precipProbability + ' Prozent. Der UV-Index liegt bei: ' + body.currently.uvIndex + '.')
    }
  })
}
